...
import Tst from '@/example-library/index';
import ActionSheet from '@/example-library/components/action-sheet';
      ...
      <Tst.Cell.Group title="选项状态">
        <Tst.Cell
          ...
          onPress={() => {
            ActionSheet({
              actions: [
                { name: '着色选项', textClassName: 'text-[#f30]' },
