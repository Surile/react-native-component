...
const BasicFieldButtonOption: React.FC = () => {
  return (
    <Cell.Group title='Field Button Option'>
      <Field.ButtonOption title='标题:单选:不可取消' options={options} deselect={false} />
      <Field.ButtonOption title='标题:单选:选中不高亮' options={options} activeHighlight={false} />
      <Field.ButtonOption title='标题:单选:outline' type='outline' options={options} />
      <Field.ButtonOption
      ...
      <Field.ButtonOption title='标题:多选:outline' type='outline' options={options} multiple />
      <Field.ButtonOption title='标题:多选' options={options2} vertical multiple />
    </Cell.Group>
  );
};
