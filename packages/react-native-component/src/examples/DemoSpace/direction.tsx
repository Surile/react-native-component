  ...
  return (
    <Tst.Blank top>
      <Tst.Space>
        ...
        <Tst.Card title='方向:horizontal:子组件过多'>
        ...
        <Tst.Card title='方向:horizontal:wrap' bodyPadding={{ bottom: false }}>
          <Text>多行的情况下边距不好消除，只好通过父节点去掉多余的边距</Text>

          <Tst.Space gap='m' direction='horizontal' wrap>
            <Tst.Button text='Button' />
            <Tst.Button text='Button' />
            <Tst.Button text='Button' />
            <Tst.Button text='Button' />
