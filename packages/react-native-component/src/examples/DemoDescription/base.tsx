  ...
  return (
    <Space>
      <Card title='基本使用' square>
        <Description.Group className='bg-gray-100'>
          ...
          <Description
            align='center'
            justify='center'
            contentClassName='basis-[200px] grow-0'
            label='对齐'
            text='一袋米要抗几楼，一袋米要抗二楼，一袋米要给多了，一袋米由我洗嘞'
          />
          <Description layout='vertical' label='配合 Uploader 组件使用'>
            {/* <Uploader list={list} style={{ flex: 1 }} showUpload={false} deletable={false} /> */}
          </Description>
        </Description.Group>
      </Card>
      ...
      <Card title='基本使用:自定义' square>
        ...
        >
          ...
          <Description
            ...
            text='一袋米要给多了'
            contentClassName='text-blue-500'
          />
